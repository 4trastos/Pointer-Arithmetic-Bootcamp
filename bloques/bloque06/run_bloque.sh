...
# ================================================================
# Script para ejecutar el Bloque 4 de ejercicios
# ----------------------------------------------------------------
...
/*
 * Ejercicio $exercise_num - Punteros y estructuras
 *
 * Instrucciones:
...
main_loop() {
    ...
    while [[ $i -le 10 ]]; do
        ...
        echo -e "${COLOR_TITLE}  BLOQUE 6: MEMÓRIA DINÁMICA Y PUNTEROS - EJERCICIO $exercise_num${COLOR_RESET}"
        echo -e "${COLOR_TITLE}=================================================${COLOR_RESET}"
